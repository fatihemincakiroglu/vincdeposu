...
export const metadata: Metadata = {
  alternates: {
    canonical: "/sultanbeyli-vinc-kiralama",
  },
  title: { absolute: "Sultanbeyli Vinç Kiralama ve Sultanbeyli Kiralık Vinç" },
  description:
    "Sultanbeyli vinç kiralama hizmetleri ile güvenli ve profesyonel çözümler sunuyoruz. Günlük, aylık Sultanbeyli kiralık vinç seçenekleri için hemen bize ulaşın!",
  keywords: ["sultanbeyli vinç kiralama", "sultanbeyli kiralık vinç", "vinç kiralama sultanbeyli", "sultanbeyli sepetli vinç", "sultanbeyli mobil vinç kiralama"],
};
...
const vincTurleri = [
  {
    ...
    desc: "Sultanbeyli'nin dar sokak ve yoğun trafiğine uyum sağlayan sepetli vinçlerimiz, personel taşıma ve yüksek noktalara erişimde en yaygın tercih. Abdurrahmangazi, Mecidiye ve merkez çevresinde de sorunsuz çalışır.",
  ...
  },
  {
    ...
    desc: "Sultanbeyli'nin büyük inşaat ve sanayi projelerinde hız ve esneklik sağlayan tekerlekli mobil vinçler. İkitelli'deki merkezimizden Sultanbeyli'ye aynı gün mobilizasyon imkânı.",
  ...
  },
  {
    ...
    desc: "Sultanbeyli'deki büyük konut ve ticari yapı projelerinde aylarca sabit çalışan, yüksek irtifada hassas yük taşıma yapan vinç türü. Uzun vadeli projeler için en ekonomik seçenek.",
  ...
  },
  {
    ...
    desc: "Sultanbeyli'nin tarihi bina restorasyonları ve dar yapı adalarında kompakt yapısı ve çok yönlü hareketliliği ile tercih edilen vinç türü. Kapalı mekân projelerinde fark yaratır.",
  ...
  },
  {
    ...
    desc: "Sultanbeyli ve çevresindeki büyük altyapı, enerji ve kentsel dönüşüm projelerinde yumuşak ve zorlu arazide çalışabilen yüksek kapasiteli paletli vinçler. Büyük enerji ve altyapı projelerinin tercihi.",
  ...
  },
  {
    ...
    desc: "Sultanbeyli ve çevre liman, şantiyeler ve lojistik merkezlerinde kamyon kasasına monte edilen pratik vinç türü. Yük taşıma ve indirme işlemlerini araç üzerinden hızlıca gerçekleştirir.",
...
const kullanımAlanlari = [
  { icon: "🏗️", title: "Yüksek Yapı İnşaatı", desc: "Sultanbeyli'nin yükselen konut ve ofis projelerinde kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  { icon: "🏭", title: "Fabrika & Sanayi", desc: "Sultanbeyli sanayi bölgelerinde ağır makine montajı, ekipman taşıma ve yerleştirme." },
  { icon: "⚡", title: "Enerji Projeleri", desc: "Sultanbeyli çevresinde rüzgar türbini montajı, trafo kurulumu, solar panel çalışmaları." },
  ...
  { icon: "🚢", title: "Liman & Tersane", desc: "Sultanbeyli ve çevresindeki limanlarda konteyner yükleme, tekne bakımı ve liman operasyonları." },
  { icon: "🛣️", title: "Altyapı Projeleri", desc: "Sultanbeyli'nin köprü, tünel, metro ve otoyol inşaat çalışmalarında profesyonel destek." },
  { icon: "📡", title: "Telekom & Anten", desc: "Sultanbeyli ve çevresinde baz istasyonu kurulumu, anten montajı, çatı ekipmanı yerleşimi." },
  { icon: "🌳", title: "Peyzaj & Park", desc: "Sultanbeyli park ve bahçelerinde ağırlıklı ağaç nakliyesi, anıt taş ve heykel yerleşimi." },
];
...
const adimlar = [
  ...
  { no: "05", icon: "🚛", title: "Vinç Sultanbeyli'ye Teslim Edilir", desc: "Belirlenen tarihte Sultanbeyli'deki şantiyenize kurulum ekibi ile ulaşırız." },
  { no: "06", icon: "✅", title: "İş Tamamlanır", desc: "Operasyon sona erince vinç teslim alınır, alan temizlenir." },
];

const neden = [
  { icon: "🏆", title: "25 Yıllık Sultanbeyli Deneyimi", desc: "Sultanbeyli'de çeyrek asır, 1000+ başarıyla tamamlanan proje." },
  { icon: "🛡️", title: "Tam Sigortalı", desc: "Tüm ekipman ve operasyonlar kapsamlı sigorta güvencesinde." },
  { icon: "⚡", title: "Aynı Gün Teslimat", desc: "Sultanbeyli ve çevresinde stok garantisiyle acil taleplerde aynı gün vinç sahada." },
...
const sss = [
  {
    s: "Sultanbeyli'de vinç kiralama fiyatları nasıl belirleniyor?",
    c: "Sultanbeyli'de vinç kiralama fiyatı; ilçe ve ulaşım mesafesi, seçilen vinç türü ve kapasitesi, kiralama süresi ile operatör ihtiyacına göre değişir. Uzmanımız projenizi inceleyerek şeffaf fiyat teklifi sunar.",
  },
  {
    s: "Sultanbeyli'nin her ilçesine hizmet veriyor musunuz?",
  ...
  {
    s: "Sultanbeyli trafiğinde vinç ulaşımı nasıl sağlanıyor?",
    c: "Sultanbeyli trafiğine hakim ekibimiz, vinç sevkiyatlarını gece saatlerinde veya yoğunluğu az olan güzergahlarda planlayarak maksimum hız sağlar. Büyük ekipmanlar için belediye izinlerini de biz alıyoruz.",
  },
  {
  ...
  },
  {
    ...
    c: "Standart fiyata vinç, operatör ve sigorta dahildir. Sultanbeyli içi nakliye belirli sınırlar dahilinde ücretsizdir; şehir dışı nakliye, gece çalışması ve özel izin ücretleri ayrıca yansıtılır.",
  },
  {
    s: "Uzun dönem kiralama daha mı ucuz?",
    c: "Evet. Aylık ve üzeri kiralamalarda günlük fiyata göre %20–35 indirim uygulanmaktadır. Büyük Sultanbeyli projeleri için özel paket fiyatları da sunulmaktadır.",
  },
  {
    s: "Sultanbeyli dışına da hizmet veriyor musunuz?",
    c: "Trakya, Marmara ve çevre illere hizmet verilmektedir. Sultanbeyli dışı nakliye bedeli ayrıca hesaplanır.",
  },
];
...
export default function SultanbeyliVincKiralamaPage() {
  return (
    <>
      {/* ══════════════════════════════════════
          HERO
      ...
      <section id="vinc-turleri" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Sultanbeyli Vinç Kiralama Türleri</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-gray-900 mb-1">Sultanbeyli {v.title} Kiralama</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Sultanbeyli Vinç Kiralama Fiyat Listesi</h2>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-3">
              <div>
                ...
                <div className="text-gray-600 text-xs leading-relaxed">Sultanbeyli dışı nakliye, gece mesaisi ve özel izin ayrıca fiyatlandırılır.</div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Sultanbeyli Vinç Kiralama Kullanım Alanları</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              İnşaattan enerjiye, limanlardan telekomünikasyona — Sultanbeyli&apos;da vinç gereken her yerde yanınızdayız.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">6 Adımda Sultanbeyli Vinç Kiralama</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-8">
                ...
                operatörlerimiz ve 7/24 destek hattımızla Sultanbeyli vinç kiralama sektöründe fark yaratıyoruz.
              </p>
              <a
                href="tel:05323039089"
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Sultanbeyli Vinç Kiralama Sık Sorulan Sorular</h2>
            <p className="text-gray-500 text-lg">Sultanbeyli vinç kiralama hakkında en çok merak edilenler.</p>
          </div>
          ...
          <div className="mt-10 p-8 bg-yellow-400 rounded-3xl text-center">
            <div className="text-2xl font-black text-gray-900 mb-2">Sultanbeyli vinç kiralama hakkında başka sorunuz mu var?</div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-3">Sultanbeyli Vinç Kiralama ile Birlikte</h2>
          </div>
