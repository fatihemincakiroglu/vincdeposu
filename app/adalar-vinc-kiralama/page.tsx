...
export const metadata: Metadata = {
  alternates: {
    canonical: "/adalar-vinc-kiralama",
  },
  title: { absolute: "Adalar Vinç Kiralama ve Adalar Kiralık Vinç" },
  description:
    "Adalar vinç kiralama hizmetleri ile güvenli ve profesyonel çözümler sunuyoruz. Günlük, aylık Adalar kiralık vinç seçenekleri için hemen bize ulaşın!",
  keywords: ["adalar vinç kiralama", "adalar kiralık vinç", "vinç kiralama adalar", "adalar sepetli vinç", "adalar mobil vinç kiralama"],
};
...
const vincTurleri = [
  {
    ...
    href: "/sepetli-vinc",
    kapasite: "12m – 45m",
    kullanim: "Cephe, çatı, restorasyon",
    desc: "Büyükada, Heybeliada ve Burgazada'daki tarihi ahşap köşklerin cephe ve çatı çalışmalarında sıkça tercih edilir. Dar ada sokaklarına uygun kompakt modeller önceliklidir.",
    ozellikler: ["Ahşap köşk restorasyonu", "Dar sokaklara uygun", "Hızlı kurulum", "Geniş erişim açısı"],
  },
  {
    icon: "🏗️",
    renk: "#3B82F6",
    ...
    href: "/mobil-vinc",
    kapasite: "25 – 100 ton",
    kullanim: "İnşaat, yapı malzemesi taşıma",
    desc: "Adalar'a araba vapuruyla taşınan, motorlu taşıt trafiğinin kısıtlı olduğu sokaklara uygun küçük ve orta kapasiteli mobil vinçlerimiz, iskele ve şantiye malzemesi taşımada kullanılır.",
    ozellikler: ["Vapurla nakliye uyumlu", "Orta kapasite seçenekleri", "Şantiye malzeme taşıma", "Esnek mobilizasyon"],
  },
  {
    icon: "🐙",
    renk: "#EC4899",
    ...
    href: "/ahtapot-vinc",
    kapasite: "5 – 30 ton",
    kullanim: "Dar sokak, bahçe içi",
    desc: "Adalar'ın motorlu araç trafiğine kapalı dar sokaklarında ve bahçe içlerinde manevra yapabilen kompakt ahtapot vinçlerimiz, korunaklı tarihi dokuya zarar vermeden çalışır.",
    ozellikler: ["Bahçe içi çalışma", "Dar sokak manevrası", "Kompakt yapı", "Tarihi dokuya uyumlu"],
  },
  {
    icon: "🦾",
    renk: "#14B8A6",
    ...
    kapasite: "10m – 30m",
    kullanim: "Bahçe ağaçları, cephe detayı",
    desc: "Adalar'ın yoğun ağaçlık bahçelerinde ve köşklerin girinti-çıkıntılı cephelerinde, engellerin üzerinden geçerek erişim sağlayan eklemli platformlar tercih edilir.",
    ozellikler: ["Ağaçlı bahçe uyumu", "Engel aşma kabiliyeti", "Hassas cephe işleri", "Akülü-sessiz modeller"],
  },
  {
    icon: "🕷️",
    renk: "#8B5CF6",
    ...
    href: "/orumcek-platform",
    kapasite: "10m – 20m",
    kullanim: "Hassas zemin, taş döşeme",
    desc: "Adalar'ın taş döşeli tarihi sokaklarına ve hassas bahçe zeminlerine zarar vermeyen, hafif ayak izi bırakan örümcek platformlar, koruma altındaki alanlarda güvenle kullanılır.",
    ozellikler: ["Zemine zarar vermez", "Taş döşeme uyumlu", "Hafif ve kompakt", "Koruma alanlarına uygun"],
  },
];
...
const fiyatTablosu = [
  ...
  { tur: "Mobil Vinç (25t)", saatlik: "1.200 TL", gunluk: "12.000 TL", haftalik: "65.000 TL", aylik: "Teklif" },
  { tur: "Mobil Vinç (50t)", saatlik: "1.500 TL", gunluk: "15.000 TL", haftalik: "80.000 TL", aylik: "Teklif" },
  { tur: "Ahtapot Vinç", saatlik: "1.300 TL", gunluk: "11.000 TL", haftalik: "60.000 TL", aylik: "Teklif" },
  { tur: "Eklemli Platform", saatlik: "Teklif", gunluk: "9.000 TL", haftalik: "48.000 TL", aylik: "Teklif" },
  { tur: "Örümcek Platform", saatlik: "Teklif", gunluk: "10.000 TL", haftalik: "52.000 TL", aylik: "Teklif" },
  { tur: "Operatör (ek)", saatlik: "500 TL", gunluk: "2.000 TL", haftalik: "10.000 TL", aylik: "35.000 TL" },
];

const kullanımAlanlari = [
  { icon: "🏛️", title: "Tarihi Köşk Restorasyonu", desc: "Büyükada ve Heybeliada'daki 19. yüzyıldan kalma ahşap köşklerin cephe, çatı ve balkon restorasyonunda hassas kaldırma desteği." },
  { icon: "🌳", title: "Bahçe ve Peyzaj İşleri", desc: "Adalar'ın yeşil dokusunu koruyan bahçelerde ağaç budama, peyzaj düzenlemesi ve malzeme taşıma." },
  { icon: "⛪", title: "Dini ve Tarihi Yapılar", desc: "Ada üzerindeki kilise, manastır ve cami gibi tarihi yapıların bakım ve onarım çalışmaları." },
  { icon: "🏠", title: "Konut Yenileme", desc: "Yazlık ve kalıcı konutların çatı, cephe ve çevre düzenleme projelerinde güvenli erişim." },
  { icon: "⚓", title: "İskele ve Liman Çevresi", desc: "Vapur iskeleleri ve çevresindeki bakım, tabela ve aydınlatma montaj çalışmaları." },
  { icon: "🚲", title: "Bisiklet Yolu ve Altyapı", desc: "Motorlu araç trafiğinin kısıtlı olduğu adalarda altyapı ve aydınlatma çalışmalarına uygun kompakt ekipman." },
];

const adimlar = [
  { no: "01", icon: "📞", title: "Arayın veya WhatsApp Yazın", desc: "Hangi adada (Büyükada, Heybeliada, Burgazada vb.) çalışma yapılacağını ve proje detaylarını belirtin." },
  { no: "02", icon: "🚢", title: "Vapur ve Lojistik Planı", desc: "Uzmanımız ekipmanın araba vapuruyla taşınması için en uygun sefer saatini ve güzergahı planlar." },
  { no: "03", icon: "📋", title: "Fiyat Teklifi", desc: "Nakliye dahil şeffaf, kalem kalem fiyatlandırma e-posta ile iletilir." },
  { no: "04", icon: "✍️", title: "Sözleşme İmzalanır", desc: "Kiralama koşulları, sigorta ve operatör detayları netleşir." },
  { no: "05", icon: "🚛", title: "Vinç Adaya Teslim Edilir", desc: "Ekipman belirlenen vapur seferiyle adaya taşınır, şantiye alanına kurulur." },
  { no: "06", icon: "✅", title: "İş Tamamlanır", desc: "Operasyon sona erince vinç teslim alınır, alan temizlenir ve geri taşınır." },
];

const neden = [
  { icon: "🏆", title: "Adalar Lojistiğinde Tecrübe", desc: "Araba vapuru sevkiyatı, dar sokak erişimi ve tarihi doku hassasiyetinde uzmanlaşmış ekip." },
  { icon: "🛡️", title: "Tam Sigortalı", desc: "Tüm ekipman ve operasyonlar kapsamlı sigorta güvencesinde." },
  { icon: "⛴️", title: "Vapur Sefer Planlaması", desc: "Ekipman nakliyesi, araba vapuru sefer saatlerine göre önceden planlanır, gecikme riski azaltılır." },
  { icon: "👷", title: "Sertifikalı Operatör", desc: "MEB onaylı belgeli, tarihi yapı hassasiyetine aşina operatörler." },
...
const sss = [
  {
    s: "Vinç Adalar'a nasıl taşınıyor?",
    c: "Ekipmanlarımız İstanbul'daki depomuzdan araba vapuru (RO-RO/araç vapuru) ile adaya taşınır. Vapur sefer saatlerine göre nakliye süreci önceden planlanır.",
  },
  {
    s: "Adalar'da motorlu araç kısıtlaması vinç çalışmasını etkiler mi?",
    c: "Adalar'da kalıcı motorlu özel araç trafiği kısıtlıdır; ancak iş makineleri ve hizmet araçları belediye izniyle çalışma alanına girebilir. Ekibimiz gerekli izin süreçlerini sizin için yönetir.",
  },
  {
    s: "Hangi adalara hizmet veriyorsunuz?",
    c: "Büyükada, Heybeliada, Burgazada ve Kınalıada dahil Adalar ilçesinin tüm yerleşim adalarına vapur lojistiğiyle hizmet veriyoruz.",
  },
  {
    s: "Tarihi köşklerde çalışırken nelere dikkat ediliyor?",
    c: "Koruma altındaki tarihi yapılarda zemine ve cepheye zarar vermeyen hafif ayak izli ekipmanlar (örümcek platform, kompakt ahtapot vinç) tercih edilir; çalışma öncesi alan değerlendirmesi yapılır.",
  },
  {
  ...
  },
  {
    ...
    c: "Vapur nakliyesi gerektiren adalar için minimum 1 günlük kiralama önerilir; sepetli vinçte yarım gün (4 saat) seçeneği bazı projelerde uygulanabilir.",
  },
  {
    s: "Fiyata vapur nakliyesi dahil mi?",
    c: "Standart fiyata vinç, operatör ve sigorta dahildir. Araba vapuru bilet/nakliye bedeli ayrıca hesaplanıp teklife şeffaf şekilde eklenir.",
  },
  {
    s: "Kış sezonunda da hizmet veriyor musunuz?",
    c: "Evet, 7/24 hizmet anlayışıyla yıl boyunca hizmet veriyoruz; ancak fırtınalı havalarda vapur seferlerinin iptali nakliye süresini etkileyebilir, bu durumda alternatif sefer planlanır.",
  },
];
...
export default function AdalarVincKiralamaPage() {
  return (
    <>
      {/* ══════════════════════════════════════
          HERO
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-8">
                ...
                <span className="text-yellow-400 text-sm font-bold tracking-wide">Adalar Bölgesinde 7/24</span>
              </div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Adalar ve çevresinde sepetli vinç, mobil vinç, ahtapot vinç, eklemli ve örümcek
                platform seçenekleriyle hizmet veriyoruz. Sertifikalı operatör, tam sigorta ve
                vapur lojistiği planlamasıyla profesyonel vinç kiralama hizmeti sunuyoruz.
              </p>
      ...
      <section id="vinc-turleri" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Adalar Vinç Kiralama Türleri</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-gray-900 mb-1">Adalar {v.title} Kiralama</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Adalar Vinç Kiralama Fiyat Listesi</h2>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600 text-xs leading-relaxed">Adalar dışı nakliye, gece mesaisi ve özel izin ayrıca fiyatlandırılır.</div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Adalar Vinç Kiralama Kullanım Alanları</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Tarihi köşklerden bahçelere, iskelelerden dini yapılara — Adalar&apos;ın özel dokusuna uygun vinç çözümleri sunuyoruz.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">6 Adımda Adalar Vinç Kiralama</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                Adalar Bölgesinin<br />Tercih Ettiği<br />Vinç Kiralama Firması
              </h2>
              <p className="text-gray-500 leading-relaxed mb-8">
                Adalar&apos;da 25 yılı aşkın deneyim, geniş ve bakımlı filomuz, sertifikalı
                operatörlerimiz ve 7/24 destek hattımızla Adalar vinç kiralama sektöründe fark yaratıyoruz.
              </p>
              <a
                href="tel:05323039089"
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Adalar Vinç Kiralama Sık Sorulan Sorular</h2>
            <p className="text-gray-500 text-lg">Adalar vinç kiralama hakkında en çok merak edilenler.</p>
          </div>
          ...
          <div className="mt-10 p-8 bg-yellow-400 rounded-3xl text-center">
            <div className="text-2xl font-black text-gray-900 mb-2">Adalar vinç kiralama hakkında başka sorunuz mu var?</div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-3">Adalar Vinç Kiralama ile Birlikte</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            <div className="text-4xl font-black text-gray-900 mb-3">
              Adalar&apos;da kiralık vinç ihtiyacınız mı var?
            </div>
