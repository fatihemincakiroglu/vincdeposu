...
const ilceler = {
  avrupa: [
    { ad: "Kadıköy", slug: "kadikoy", emoji: "🏙️" },
    { ad: "Kadıköy", slug: "kadikoy", emoji: "🏗️" },
...
const vincTurleri = [
  {
    ...
    desc: "Kadıköy'ın dar sokak ve yoğun trafiğine uyum sağlayan sepetli vinçlerimiz, personel taşıma ve yüksek noktalara erişimde en yaygın tercih. Boğaz çevresi ve tarihi yarımadada da sorunsuz çalışır.",
  ...
  },
  {
    ...
    desc: "Kadıköy'ın büyük inşaat ve sanayi projelerinde hız ve esneklik sağlayan tekerlekli mobil vinçler. Avrupa'dan Anadolu yakasına aynı gün mobilizasyon imkânı.",
  ...
  },
  {
    ...
    desc: "Kadıköy'daki büyük konut ve ticari yapı projelerinde aylarca sabit çalışan, yüksek irtifada hassas yük taşıma yapan vinç türü. Uzun vadeli projeler için en ekonomik seçenek.",
  ...
  },
  {
    ...
    desc: "Kadıköy'ın tarihi bina restorasyonları ve dar yapı adalarında kompakt yapısı ve çok yönlü hareketliliği ile tercih edilen vinç türü. Kapalı mekân projelerinde fark yaratır.",
  ...
  },
  {
    ...
    desc: "Kadıköy'ın liman, tersane ve ağır sanayi bölgelerinde yumuşak ve zorlu arazide çalışabilen yüksek kapasiteli paletli vinçler. Büyük enerji ve altyapı projelerinin tercihi.",
  ...
  },
  {
    ...
    desc: "Kadıköy ve çevre liman, şantiyeler ve lojistik merkezlerinde kamyon kasasına monte edilen pratik vinç türü. Yük taşıma ve indirme işlemlerini araç üzerinden hızlıca gerçekleştirir.",
...
const kullanımAlanlari = [
  { icon: "🏗️", title: "Yüksek Yapı İnşaatı", desc: "Kadıköy'ın yükselen konut ve ofis projelerinde kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  { icon: "🏭", title: "Fabrika & Sanayi", desc: "Kadıköy sanayi bölgelerinde ağır makine montajı, ekipman taşıma ve yerleştirme." },
  { icon: "⚡", title: "Enerji Projeleri", desc: "Kadıköy çevresinde rüzgar türbini montajı, trafo kurulumu, solar panel çalışmaları." },
  ...
  { icon: "🚢", title: "Liman & Tersane", desc: "Kadıköy ve çevresindeki limanlarda konteyner yükleme, tekne bakımı ve liman operasyonları." },
  { icon: "🛣️", title: "Altyapı Projeleri", desc: "Kadıköy'ın köprü, tünel, metro ve otoyol inşaat çalışmalarında profesyonel destek." },
  { icon: "📡", title: "Telekom & Anten", desc: "Kadıköy ve çevresinde baz istasyonu kurulumu, anten montajı, çatı ekipmanı yerleşimi." },
  { icon: "🌳", title: "Peyzaj & Park", desc: "Kadıköy park ve bahçelerinde ağırlıklı ağaç nakliyesi, anıt taş ve heykel yerleşimi." },
];
...
const adimlar = [
  ...
  { no: "05", icon: "🚛", title: "Vinç Kadıköy'a Teslim Edilir", desc: "Belirlenen tarihte Kadıköy'daki şantiyenize kurulum ekibi ile ulaşırız." },
  { no: "06", icon: "✅", title: "İş Tamamlanır", desc: "Operasyon sona erince vinç teslim alınır, alan temizlenir." },
];

const neden = [
  { icon: "🏆", title: "25 Yıllık Kadıköy Deneyimi", desc: "Kadıköy'da çeyrek asır, 1000+ başarıyla tamamlanan proje." },
  { icon: "🛡️", title: "Tam Sigortalı", desc: "Tüm ekipman ve operasyonlar kapsamlı sigorta güvencesinde." },
  { icon: "⚡", title: "Aynı Gün Teslimat", desc: "Kadıköy ve çevresinde stok garantisiyle acil taleplerde aynı gün vinç sahada." },
...
const sss = [
  {
    s: "Kadıköy'da vinç kiralama fiyatları nasıl belirleniyor?",
    c: "Kadıköy'da vinç kiralama fiyatı; ilçe ve ulaşım mesafesi, seçilen vinç türü ve kapasitesi, kiralama süresi ile operatör ihtiyacına göre değişir. Uzmanımız projenizi inceleyerek şeffaf fiyat teklifi sunar.",
  },
  {
    s: "Kadıköy'ın her ilçesine hizmet veriyor musunuz?",
  ...
  {
    s: "Kadıköy trafiğinde vinç ulaşımı nasıl sağlanıyor?",
    c: "Kadıköy trafiğine hakim ekibimiz, vinç sevkiyatlarını gece saatlerinde veya yoğunluğu az olan güzergahlarda planlayarak maksimum hız sağlar. Büyük ekipmanlar için belediye izinlerini de biz alıyoruz.",
  },
  {
  ...
  },
  {
    ...
    c: "Standart fiyata vinç, operatör ve sigorta dahildir. Kadıköy içi nakliye belirli sınırlar dahilinde ücretsizdir; şehir dışı nakliye, gece çalışması ve özel izin ücretleri ayrıca yansıtılır.",
  },
  {
    s: "Uzun dönem kiralama daha mı ucuz?",
    c: "Evet. Aylık ve üzeri kiralamalarda günlük fiyata göre %20–35 indirim uygulanmaktadır. Büyük Kadıköy projeleri için özel paket fiyatları da sunulmaktadır.",
  },
  {
    s: "Kadıköy dışına da hizmet veriyor musunuz?",
    c: "Trakya, Marmara ve çevre illere hizmet verilmektedir. Kadıköy dışı nakliye bedeli ayrıca hesaplanır.",
  },
];
...
export default function KadıköyVincKiralamaPage() {
  return (
    <>
      {/* ══════════════════════════════════════
          HERO
      ...
      <section className="relative bg-gray-950 text-white min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 w-full">
          ...
          <div className="flex items-center gap-2 text-gray-500 text-sm mb-10">
            ...
            <span>›</span>
            <span className="text-gray-300">Kadıköy Vinç Kiralama</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-8">
                ...
                <span className="text-yellow-400 text-sm font-bold tracking-wide">Kadıköy&apos;un 39 İlçesinde 7/24</span>
              </div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Kadıköy&apos;un tüm 39 ilçesinde sepetli, mobil, kule, paletli ve daha fazlası.
                Sertifikalı operatör, tam sigorta ve aynı gün teslimat ile Kadıköy ve çevresinde
      ...
      <section id="vinc-turleri" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Kadıköy Vinç Kiralama Türleri</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-gray-900 mb-1">Kadıköy {v.title} Kiralama</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Kadıköy Vinç Kiralama Fiyat Listesi</h2>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600 text-xs leading-relaxed">Kadıköy dışı nakliye, gece mesaisi ve özel izin ayrıca fiyatlandırılır.</div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Kadıköy Vinç Kiralama Kullanım Alanları</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              İnşaattan enerjiye, limanlardan telekomünikasyona — Kadıköy&apos;da vinç gereken her yerde yanınızdayız.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">6 Adımda Kadıköy Vinç Kiralama</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                Kadıköy&apos;un<br />Tercih Ettiği<br />Vinç Kiralama Firması
              </h2>
              <p className="text-gray-500 leading-relaxed mb-8">
                Kadıköy&apos;da 25 yılı aşkın deneyim, geniş ve bakımlı filomuz, sertifikalı
                operatörlerimiz ve 7/24 destek hattımızla Kadıköy vinç kiralama sektöründe fark yaratıyoruz.
              </p>
              <a
                href="tel:05323039089"
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Kadıköy Vinç Kiralama Sık Sorulan Sorular</h2>
            <p className="text-gray-500 text-lg">Kadıköy vinç kiralama hakkında en çok merak edilenler.</p>
          </div>
          ...
          <div className="mt-10 p-8 bg-yellow-400 rounded-3xl text-center">
            <div className="text-2xl font-black text-gray-900 mb-2">Kadıköy vinç kiralama hakkında başka sorunuz mu var?</div>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white" id="ilceler">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Kadıköy Vinç Kiralama — 39 İlçede Hizmet</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Bulunduğunuz ilçeye tıklayarak bölgeye özel Kadıköy vinç kiralama hizmet sayfasına ulaşın.
            </p>
          </div>
          ...
          <div className="relative bg-white/5 border border-white/10 rounded-3xl overflow-hidden mb-14 p-10 text-center">
            ...
            <div className="relative">
              ...
              <div className="text-white text-2xl font-black mb-2">Kadıköy — Avrupa + Anadolu Yakası</div>
              <div className="text-gray-400">Boğazın her iki yakasında, tüm Kadıköy&apos;da aynı gün vinç kiralama hizmeti</div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-3">Kadıköy Vinç Kiralama ile Birlikte</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            <div className="text-4xl font-black text-gray-900 mb-3">
              Kadıköy&apos;da kiralık vinç ihtiyacınız mı var?
            </div>
            <div className="text-gray-800 text-lg">
              Projenizi anlatın, Kadıköy&apos;un doğru vinci hemen belirleyelim.
            </div>
          </div>
