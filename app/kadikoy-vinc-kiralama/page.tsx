...
const vincTurleri = [
  {
    ...
    desc: "Kadıköy'ün dar sokak ve yoğun trafiğine uyum sağlayan sepetli vinçlerimiz, personel taşıma ve yüksek noktalara erişimde en yaygın tercih. Moda, Fikirtepe ve Kozyatağı çevresinde de sorunsuz çalışır.",
  ...
  },
  {
    ...
    desc: "Kadıköy'ün büyük inşaat ve sanayi projelerinde hız ve esneklik sağlayan tekerlekli mobil vinçler. İkitelli'deki merkezimizden Kadıköy'e aynı gün mobilizasyon imkânı.",
  ...
  },
  {
    ...
    desc: "Kadıköy'deki büyük konut ve ticari yapı projelerinde aylarca sabit çalışan, yüksek irtifada hassas yük taşıma yapan vinç türü. Uzun vadeli projeler için en ekonomik seçenek.",
  ...
  },
  {
    ...
    desc: "Kadıköy'ün tarihi bina restorasyonları ve dar yapı adalarında kompakt yapısı ve çok yönlü hareketliliği ile tercih edilen vinç türü. Kapalı mekân projelerinde fark yaratır.",
  ...
  },
  {
    ...
    desc: "Kadıköy ve çevresindeki büyük altyapı, enerji ve kentsel dönüşüm projelerinde yumuşak ve zorlu arazide çalışabilen yüksek kapasiteli paletli vinçler. Büyük enerji ve altyapı projelerinin tercihi.",
...
const kullanımAlanlari = [
  { icon: "🏗️", title: "Yüksek Yapı İnşaatı", desc: "Kadıköy'ün yükselen konut ve ofis projelerinde kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  ...
  { icon: "🛣️", title: "Altyapı Projeleri", desc: "Kadıköy'ün köprü, tünel, metro ve otoyol inşaat çalışmalarında profesyonel destek." },
...
const adimlar = [
  ...
  { no: "05", icon: "🚛", title: "Vinç Kadıköy'e Teslim Edilir", desc: "Belirlenen tarihte Kadıköy'deki şantiyenize kurulum ekibi ile ulaşırız." },
  { no: "06", icon: "✅", title: "İş Tamamlanır", desc: "Operasyon sona erince vinç teslim alınır, alan temizlenir." },
];

const neden = [
  { icon: "🏆", title: "25 Yıllık Kadıköy Deneyimi", desc: "Kadıköy'de çeyrek asır, 1000+ başarıyla tamamlanan proje." },
...
const sss = [
  {
    s: "Kadıköy'de vinç kiralama fiyatları nasıl belirleniyor?",
    c: "Kadıköy'de vinç kiralama fiyatı; ilçe ve ulaşım mesafesi, seçilen vinç türü ve kapasitesi, kiralama süresi ile operatör ihtiyacına göre değişir. Uzmanımız projenizi inceleyerek şeffaf fiyat teklifi sunar.",
  },
  {
    s: "Kadıköy'ün her ilçesine hizmet veriyor musunuz?",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-8">
                ...
                <span className="text-yellow-400 text-sm font-bold tracking-wide">Kadıköy Bölgesinde 7/24</span>
              </div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Kadıköy ve çevresinde sepetli, mobil, kule, paletli vinç ve daha fazlası.
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                Kadıköy Bölgesinin<br />Tercih Ettiği<br />Vinç Kiralama Firması
              </h2>
