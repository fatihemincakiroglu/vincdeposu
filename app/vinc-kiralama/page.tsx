...
const vincTurleri = [
  {
    ...
    desc: "Personel taşıma sepeti olan, yüksek noktalara erişim için en yaygın tercih. Dar sokakta da çalışır.",
  ...
  },
  {
    ...
    desc: "Tekerlekli şasi üzerinde hareket eden, şehir içi ve şehirlerarası projelerde hız ve esneklik sağlayan vinç.",
  ...
  },
  {
    ...
    desc: "Büyük inşaat projelerinde aylarca sabit çalışan, yüksek irtifada hassas yük taşıma yapan vinç türü.",
  ...
  },
  {
    ...
    desc: "Kompakt yapısı ve çok yönlü hareketliliği ile dar alanlarda, bina içinde ve kapalı mekânlarda tercih edilir.",
  ...
  },
  {
    ...
    desc: "Yumuşak ve zorlu arazide çalışabilen, büyük kapasite gerektiren sanayi ve enerji projelerinin tercihi.",
  ...
  },
  {
    ...
    desc: "Kamyon kasasına monte edilen, yük taşıma ve indirme işlemlerini araç üzerinden yapan pratik vinç türü.",
...
const kullanımAlanlari = [
  { icon: "🏗️", title: "Yüksek Yapı İnşaatı", desc: "Kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  { icon: "🏭", title: "Fabrika & Sanayi", desc: "Ağır makine montajı, ekipman taşıma ve yerleştirme." },
  { icon: "⚡", title: "Enerji Projeleri", desc: "Rüzgar türbini montajı, trafo kurulumu, solar panel." },
  { icon: "🏠", title: "Dış Cephe Bakımı", desc: "Boya, cam temizleme, cephe onarımı ve mantolama." },
  { icon: "🚢", title: "Liman & Tersane", desc: "Konteyner yükleme, tekne bakımı ve liman operasyonları." },
  { icon: "🛣️", title: "Altyapı Projeleri", desc: "Köprü, tünel, metro ve otoyol inşaat çalışmaları." },
  { icon: "📡", title: "Telekom & Anten", desc: "Baz istasyonu kurulumu, anten montajı, çatı ekipmanı." },
  { icon: "🌳", title: "Peyzaj & Park", desc: "Ağırlıklı ağaç nakliyesi, anıt taş ve heykel yerleşimi." },
];

const adimlar = [
  { no: "01", icon: "📞", title: "Arayın veya WhatsApp Yazın", desc: "İhtiyacınızı, yükün ağırlığını, çalışma yüksekliğini ve süreyi belirtin." },
  { no: "02", icon: "🔍", title: "Keşif & Uygun Vinç Seçimi", desc: "Uzmanımız projenizi analiz eder, doğru vinç tipini belirler." },
  ...
  { no: "05", icon: "🚛", title: "Vinç Teslim Edilir", desc: "Belirlenen tarihte şantiyenize kurulum ekibi ile ulaşırız." },
...
const neden = [
  ...
  { icon: "⚡", title: "Aynı Gün Teslimat", desc: "Stok garantisiyle acil taleplerde aynı gün vinç sahada." },
...
const sss = [
  {
    s: "Vinç kiralarken nelere dikkat etmeliyim?",
    c: "Yükün ağırlığı ve boyutu, kaldırma yüksekliği, çalışma alanının genişliği ve zeminin taşıma kapasitesi en kritik faktörlerdir. Uzmanımız bu bilgilerle doğru vinç tipini belirler.",
  },
  {
  ...
  {
    s: "Kötü havada çalışma durduruluyor mu?",
    c: "Evet. Rüzgar hızı, yağmur ve buzlanma durumunda çalışma güvenlik gereği durdurulur. Bu süreler faturalanmaz.",
  },
  {
    s: "Kiraladığım vinç arızalanırsa ne olur?",
    c: "Arıza durumunda yedek ekipman veya tamir ekibi en hızlı şekilde yönlendirilir. Arıza süresi için ücret alınmaz.",
  },
  {
    s: "Uzun dönem kiralama daha mı ucuz?",
    c: "Evet. Aylık ve üzeri kiralamalarda günlük fiyata göre %20–35 indirim uygulanmaktadır.",
  },
  {
    s: "İstanbul dışına da hizmet veriyor musunuz?",
    c: "Trakya, Marmara ve çevre illere hizmet verilmektedir. Şehir dışı nakliye bedeli ayrıca hesaplanır.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Sepetli, mobil, kule, paletli ve daha fazlası. Sertifikalı operatör,
                tam sigorta ve hızlı teslimat ile İstanbul genelinde profesyonel vinç kiralama.
              </p>
      ...
      <section id="vinc-turleri" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Kiralık Vinç Türleri</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-gray-900 mb-1">{v.title}</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Kiralama Fiyat Listesi</h2>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600 text-xs leading-relaxed">Şehir dışı nakliye, gece mesaisi ve özel izin ayrıca fiyatlandırılır.</div>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-xs text-gray-400">
            * Tüm fiyatlar KDV hariç olup piyasa koşullarına göre değişkenlik gösterebilir. Kesin fiyat için teklif alınız.
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Kullanım Alanları</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              İnşaattan enerjiye, limanlardan telekomünikasyona — vinç gereken her yerde yanınızdayız.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">6 Adımda Vinç Kiralama</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                İstanbul&apos;un<br />Tercih Ettiği<br />Vinç Firması
              </h2>
              <p className="text-gray-500 leading-relaxed mb-8">
                25 yılı aşkın deneyim, geniş ve bakımlı filomuz, sertifikalı
                operatörlerimiz ve 7/24 destek hattımızla fark yaratıyoruz.
              </p>
              <a
                href="tel:05323039089"
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg">Vinç kiralama hakkında en çok merak edilenler.</p>
          </div>
          ...
          <div className="mt-10 p-8 bg-yellow-400 rounded-3xl text-center">
            <div className="text-2xl font-black text-gray-900 mb-2">Başka sorunuz mu var?</div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-3">Vinç Kiralama ile Birlikte</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            <div className="text-4xl font-black text-gray-900 mb-3">
              Kiralık vinç ihtiyacınız mı var?
            </div>
            <div className="text-gray-800 text-lg">
              Projenizi anlatın, en uygun vinci hemen belirleyelim.
            </div>
          </div>
