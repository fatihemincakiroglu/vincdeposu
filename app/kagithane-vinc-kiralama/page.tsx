...
export const metadata: Metadata = {
  ...
  description:
    "Kağıthane vinç kiralama hizmetleri ile güvenli ve profesyonel çözümler sunuyoruz. Günlük, aylık Kağıthane kiralık vinç seçenekleri için hemen bize ulaşın!",
