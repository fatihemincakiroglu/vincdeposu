...
const vincTurleri = [
  {
    ...
    desc: "Zeytinburnu'nun dar sokak ve yoğun trafiğine uyum sağlayan sepetli vinçlerimiz, personel taşıma ve yüksek noktalara erişimde en yaygın tercih. Kazlıçeşme, Merkezefendi ve deri sanayi bölgesinde de sorunsuz çalışır.",
  ...
  },
  {
    ...
    desc: "Zeytinburnu'nun büyük inşaat ve sanayi projelerinde hız ve esneklik sağlayan tekerlekli mobil vinçler. İkitelli'deki merkezimizden Zeytinburnu'na aynı gün mobilizasyon imkânı.",
  ...
  },
  {
    ...
    desc: "Zeytinburnu'ndaki büyük konut ve ticari yapı projelerinde aylarca sabit çalışan, yüksek irtifada hassas yük taşıma yapan vinç türü. Uzun vadeli projeler için en ekonomik seçenek.",
  ...
  },
  {
    ...
    desc: "Zeytinburnu'nun tarihi bina restorasyonları ve dar yapı adalarında kompakt yapısı ve çok yönlü hareketliliği ile tercih edilen vinç türü. Kapalı mekân projelerinde fark yaratır.",
  ...
  },
  {
    ...
    desc: "Zeytinburnu ve çevresindeki büyük altyapı, enerji ve kentsel dönüşüm projelerinde yumuşak ve zorlu arazide çalışabilen yüksek kapasiteli paletli vinçler. Büyük enerji ve altyapı projelerinin tercihi.",
...
const kullanımAlanlari = [
  { icon: "🏗️", title: "Yüksek Yapı İnşaatı", desc: "Zeytinburnu'nun yükselen konut ve ofis projelerinde kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  ...
  { icon: "🛣️", title: "Altyapı Projeleri", desc: "Zeytinburnu'nun köprü, tünel, metro ve otoyol inşaat çalışmalarında profesyonel destek." },
...
const adimlar = [
  ...
  { no: "05", icon: "🚛", title: "Vinç Zeytinburnu'na Teslim Edilir", desc: "Belirlenen tarihte Zeytinburnu'ndaki şantiyenize kurulum ekibi ile ulaşırız." },
  { no: "06", icon: "✅", title: "İş Tamamlanır", desc: "Operasyon sona erince vinç teslim alınır, alan temizlenir." },
];

const neden = [
  { icon: "🏆", title: "25 Yıllık Zeytinburnu Deneyimi", desc: "Zeytinburnu'nda çeyrek asır, 1000+ başarıyla tamamlanan proje." },
...
const sss = [
  {
    s: "Zeytinburnu'nda vinç kiralama fiyatları nasıl belirleniyor?",
    c: "Zeytinburnu'nda vinç kiralama fiyatı; ilçe ve ulaşım mesafesi, seçilen vinç türü ve kapasitesi, kiralama süresi ile operatör ihtiyacına göre değişir. Uzmanımız projenizi inceleyerek şeffaf fiyat teklifi sunar.",
  },
  {
    s: "Zeytinburnu'nun her ilçesine hizmet veriyor musunuz?",
...
export default function ZeytinburnuVincKiralamaPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-8">
                ...
                <span className="text-yellow-400 text-sm font-bold tracking-wide">Zeytinburnu Bölgesinde 7/24</span>
              </div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Zeytinburnu ve çevresinde sepetli, mobil, kule, paletli vinç ve daha fazlası.
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                Zeytinburnu Bölgesinin<br />Tercih Ettiği<br />Vinç Kiralama Firması
              </h2>
      ...
      <IlceGrid aktifSlug="zeytinburnu" />
