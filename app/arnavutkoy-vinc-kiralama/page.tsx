...
export const metadata: Metadata = {
  alternates: {
    canonical: "/arnavutkoy-vinc-kiralama",
  },
  title: { absolute: "Arnavutköy Vinç Kiralama ve Arnavutköy Kiralık Vinç" },
  description:
    "Arnavutköy vinç kiralama hizmetleri ile güvenli ve profesyonel çözümler sunuyoruz. Günlük, aylık Arnavutköy kiralık vinç seçenekleri için hemen bize ulaşın!",
...
const vincTurleri = [
  {
    ...
    href: "/mobil-vinc",
    kapasite: "25 – 500 ton",
    kullanim: "İnşaat, lojistik, sanayi",
    desc: "İstanbul Havalimanı çevresindeki geniş şantiye alanlarına ve hızla gelişen toplu konut projelerine hızlı mobilizasyon sağlayan yüksek kapasiteli mobil vinçlerimiz.",
    ozellikler: ["Geniş şantiye uyumu", "Yüksek kapasite", "Hızlı mobilizasyon", "Farklı bom uzunlukları"],
  },
  {
    icon: "🚛",
    renk: "#F59E0B",
    ...
    href: "/sepetli-vinc",
    kapasite: "12m – 90m",
    kullanim: "Cephe, depo, lojistik tesis",
    desc: "Lojistik merkezleri, depo binaları ve yeni konut bloklarının cephe, çatı ve aydınlatma işlerinde personel erişimi sağlayan sepetli vinçlerimiz.",
    ozellikler: ["Personel taşıma", "Depo/tesis uyumlu", "Hızlı kurulum", "Geniş erişim açısı"],
  },
  {
    icon: "⚙️",
    renk: "#F97316",
    ...
    kullanim: "Ağır sanayi, altyapı",
    desc: "Arnavutköy'ün açık ve geniş arazi yapısında, Kuzey Marmara Otoyolu çevresi gibi büyük altyapı ve lojistik tesis projelerinde çalışabilen yüksek kapasiteli paletli vinçler.",
    ozellikler: ["Geniş arazi uyumu", "Çok yüksek kapasite", "Stabil yapı", "Uzun bom seçenekleri"],
  },
  {
    icon: "🚚",
    renk: "#10B981",
    ...
    kapasite: "3 – 50 ton",
    kullanim: "Lojistik, kargo tesisleri",
    desc: "Havalimanı çevresindeki kargo ve lojistik tesislerinde yük taşıma, indirme ve depo malzeme yerleştirme işlerini hızlandıran araç üstü vinç çözümü.",
    ozellikler: ["Yük taşıma + indirme", "Lojistik tesis uyumu", "Hızlı teslimat", "Araç üstü çalışma"],
  },
  {
    icon: "🗼",
    renk: "#8B5CF6",
    ...
    href: "/kule-vinc",
    kapasite: "1 – 25 ton",
    kullanim: "Toplu konut, uzun süreli inşaat",
    desc: "Arnavutköy'ün hızla büyüyen toplu konut (TOKİ ve özel proje) alanlarında aylarca sabit çalışan, çok bloklu inşaatlar için ekonomik vinç çözümü.",
    ozellikler: ["Toplu konut projeleri", "Uzun vadeli kullanım", "Sabit kurulum", "Düşük günlük maliyet"],
  },
  {
    icon: "🐙",
    renk: "#EC4899",
    ...
    href: "/ahtapot-vinc",
    kapasite: "10 – 50 ton",
    kullanim: "Köy içi, dar alan",
    desc: "Arnavutköy'ün hâlâ köy dokusunu koruyan yerleşim alanlarındaki dar sokaklarda ve bina içi çalışmalarda manevra kabiliyeti sunan kompakt vinç türü.",
    ozellikler: ["Dar alan manevra", "Köy içi uyumlu", "Kompakt yapı", "Çok yönlü hareket"],
  },
];
...
const fiyatTablosu = [
  ...
  { tur: "Kamyon Üstü Vinç", saatlik: "1.000 TL", gunluk: "9.000 TL", haftalik: "50.000 TL", aylik: "Teklif" },
  { tur: "Operatör (ek)", saatlik: "500 TL", gunluk: "2.000 TL", haftalik: "10.000 TL", aylik: "35.000 TL" },
];

const kullanımAlanlari = [
  { icon: "✈️", title: "Havalimanı Çevresi Lojistik", desc: "İstanbul Havalimanı çevresindeki kargo, depo ve lojistik tesislerinde kurulum ve bakım çalışmaları." },
  { icon: "🏘️", title: "Toplu Konut Projeleri", desc: "Hızla büyüyen TOKİ ve özel toplu konut alanlarında kat arası beton döküm, kolon montajı, iskelet kurulumu." },
  { icon: "📦", title: "Depo & Antrepo Yapıları", desc: "Geniş hacimli depo ve antrepo binalarının çelik konstrüksiyon ve cephe montaj işleri." },
  { icon: "🛣️", title: "Otoyol & Altyapı", desc: "Kuzey Marmara Otoyolu ve çevresindeki köprü, menfez ve altyapı çalışmalarında ağır ekipman desteği." },
  { icon: "🌾", title: "Tarımdan Kentsel Dönüşüme", desc: "Tarım arazisinden konut/sanayi alanına dönüşen bölgelerde yeni yapı projeleri." },
  { icon: "📡", title: "Telekom & Enerji Altyapısı", desc: "Hızla genişleyen yerleşim alanlarında baz istasyonu, trafo ve enerji hattı kurulum çalışmaları." },
];
...
const adimlar = [
  ...
  { no: "05", icon: "🚛", title: "Vinç Arnavutköy'e Teslim Edilir", desc: "Belirlenen tarihte Arnavutköy'deki şantiyenize kurulum ekibi ile ulaşırız." },
...
const neden = [
  ...
  { icon: "⚡", title: "Hızlı Mobilizasyon", desc: "Havalimanı çevresi ve yeni gelişim bölgelerinde stok garantisiyle aynı gün vinç sahada." },
...
const sss = [
  {
    s: "Arnavutköy'de vinç kiralama fiyatları nasıl belirleniyor?",
    c: "Arnavutköy'de vinç kiralama fiyatı; seçilen vinç türü ve kapasitesi, kiralama süresi, çalışma lokasyonu (havalimanı çevresi, yeni yerleşim alanı vb.) ve operatör ihtiyacına göre değişir.",
  },
  {
    s: "İstanbul Havalimanı çevresindeki şantiyelere hizmet veriyor musunuz?",
    c: "Evet. Havalimanı çevresindeki lojistik tesis, depo ve inşaat projelerine düzenli olarak mobil ve sepetli vinç hizmeti sağlıyoruz.",
  },
  {
    s: "Toplu konut projelerinde uzun dönem kiralama yapılıyor mu?",
    c: "Evet. Çok bloklu toplu konut projelerinde aylık ve proje süresi boyunca kule vinç veya mobil vinç kiralama seçenekleri ekonomik avantaj sağlar.",
  },
  {
    s: "Arnavutköy'ün köy yerleşimlerine de hizmet veriyor musunuz?",
    c: "Evet. Hem yeni gelişen kentsel alanlara hem de köy dokusunu koruyan yerleşimlere uygun ekipmanla (örneğin ahtapot vinç) hizmet veriyoruz.",
  },
  {
  ...
  },
  {
    ...
    c: "Evet. Aylık ve üzeri kiralamalarda günlük fiyata göre %20–35 indirim uygulanmaktadır. Büyük toplu konut projeleri için özel paket fiyatları da sunulmaktadır.",
  },
];
...
export default function ArnavutkoyVincKiralamaPage() {
  return (
    <>
      {/* ══════════════════════════════════════
          HERO
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-8">
                ...
                <span className="text-yellow-400 text-sm font-bold tracking-wide">Arnavutköy Bölgesinde 7/24</span>
              </div>
              ...
              <p className="text-gray-400 text-xl mb-10 leading-relaxed">
                Arnavutköy ve çevresinde sepetli, mobil, kule, paletli vinç ve daha fazlası.
      ...
      <section id="vinc-turleri" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Arnavutköy Vinç Kiralama Türleri</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-gray-900 mb-1">Arnavutköy {v.title} Kiralama</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Arnavutköy Vinç Kiralama Fiyat Listesi</h2>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600 text-xs leading-relaxed">Arnavutköy dışı nakliye, gece mesaisi ve özel izin ayrıca fiyatlandırılır.</div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black mt-3 mb-4">Arnavutköy Vinç Kiralama Kullanım Alanları</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Havalimanından toplu konuta, depo tesislerinden otoyol projelerine — Arnavutköy&apos;de vinç gereken her yerde yanınızdayız.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">6 Adımda Arnavutköy Vinç Kiralama</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900 mt-3 mb-6 leading-tight">
                Arnavutköy Bölgesinin<br />Tercih Ettiği<br />Vinç Kiralama Firması
              </h2>
              <p className="text-gray-500 leading-relaxed mb-8">
                Arnavutköy&apos;de 25 yılı aşkın deneyim, geniş ve bakımlı filomuz, sertifikalı
                operatörlerimiz ve 7/24 destek hattımızla Arnavutköy vinç kiralama sektöründe fark yaratıyoruz.
              </p>
              <a
                href="tel:05323039089"
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-3 mb-4">Arnavutköy Vinç Kiralama Sık Sorulan Sorular</h2>
            <p className="text-gray-500 text-lg">Arnavutköy vinç kiralama hakkında en çok merak edilenler.</p>
          </div>
          ...
          <div className="mt-10 p-8 bg-yellow-400 rounded-3xl text-center">
            <div className="text-2xl font-black text-gray-900 mb-2">Arnavutköy vinç kiralama hakkında başka sorunuz mu var?</div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-3">Arnavutköy Vinç Kiralama ile Birlikte</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            <div className="text-4xl font-black text-gray-900 mb-3">
              Arnavutköy&apos;de kiralık vinç ihtiyacınız mı var?
            </div>
